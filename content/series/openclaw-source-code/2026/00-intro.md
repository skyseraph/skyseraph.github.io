...
| # | 文章 | 状态 | 说明 |
|:---|:---|:---|:---|
| 01 | [整体架构概览：目录结构与模块划分](./01-architecture-overview.md) | ✅ 完成 | src/ 核心目录 + extensions/ |
| 02 | [Gateway 控制平面：API 路由与协议](./02-gateway-arch.md) | ✅ 完成 | Gateway 控制平面 |
| 03 | [Plugin SDK：扩展机制与公开 API](./03-plugin-sdk.md) | ✅ 完成 | 插件 SDK 架构 |
| 04 | [Agent Runtime：任务编排与执行](./04-agent-runtime.md) | ✅ 完成 | Agent 运行时 |

### Part 2：核心机制

| # | 文章 | 状态 | 说明 |
|:---|:---|:---|:---|
| 05 | [Provider 系统：多模型统一接口](./05-provider-system.md) | ✅ 完成 | 40+ 模型厂商抽象 |
| 06 | [Channel 系统：多渠道消息接入](./06-channel-system.md) | ✅ 完成 | 消息渠道抽象 |
| 07 | [会话与状态管理](./07-session-state.md) | ✅ 完成 | 会话生命周期 |
| 08 | [记忆系统：Memory Architecture](./08-memory-system.md) | ✅ 完成 | 长期记忆 |
...
| # | 文章 | 状态 | 说明 |
|:---|:---|:---|:---|
| 12 | [测试策略：单元/集成/E2E](./12-testing-strategy.md) | ✅ 完成 | Vitest + E2E |
| 13 | [配置系统：Schema 与验证](./13-config-system.md) | ✅ 完成 | 配置管理 |
| 14 | [安全机制：Auth 与权限](./14-security-auth.md) | ✅ 完成 | 认证授权 |
| 15 | [部署与运维：Docker 与容器化](./15-deployment-docker.md) | ✅ 完成 | 生产部署 |
